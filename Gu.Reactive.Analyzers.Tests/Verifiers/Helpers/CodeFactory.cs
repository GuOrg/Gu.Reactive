        ...
        private static Solution CreateSolution(ProjectId projectId, string language)
        {
            try
            {
                ...
                var solution = new AdhocWorkspace()
                    ...
                    .AddMetadataReference(projectId, MetadataReferences.GuReactive)
                    .AddMetadataReference(projectId, MetadataReferences.GuWpfReactive);

                solution.Workspace.Options = solution.Workspace.Options
