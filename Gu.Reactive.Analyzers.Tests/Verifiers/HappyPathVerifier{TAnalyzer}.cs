namespace Gu.Reactive.Analyzers.Tests.Verifiers
{
        ...
        where TAnalyzer : DiagnosticAnalyzer, new()
    {
        ...
        {
            await DiagnosticVerifier.VerifyCSharpDiagnosticAsync(testCode, Verifiers.DiagnosticVerifier.EmptyDiagnosticResults, CancellationToken.None).ConfigureAwait(false);
        }
    }
}