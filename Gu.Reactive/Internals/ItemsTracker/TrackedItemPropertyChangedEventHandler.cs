namespace Gu.Reactive.Internals
{
    ...
    internal delegate void TrackedItemPropertyChangedEventHandler<TItem, TProperty>(TItem item, object sender, PropertyChangedEventArgs e, SourceAndValue<TProperty> sourceAndValue);
}