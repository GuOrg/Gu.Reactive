namespace Gu.Wpf.Reactive.Tests
{
    ...
    public class AsyncParameterResultCommandTests
    {
        private TaskCompletionSource<int> _tcs;
        private Task<int> _task;
        private AsyncResultCommand<int,int> _command;
        ...
        public void SetUp()
        {
            ...
            _task = _tcs.Task;
            _command = new AsyncResultCommand<int, int>(x => _task);
        }
        ...
        {
            var command = new AsyncResultCommand<int,int>(x => _task, x => x == i);
