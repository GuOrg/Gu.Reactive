namespace Gu.Reactive.Tests.Conditions
{
    ...
    public class AndConditionCollectionTests
    {
        ...
        public void IsSatisfiedIsTrueIfAnyChildIsTrue(bool? first, bool? second, bool? third, bool? expected)
        {
            ...
            var collection = new AndConditionCollection(this._mock1.Object, this._mock2.Object, this._mock3.Object);
        ...
        public void NotifiesTest()
        {
            ...
            var collection = new AndConditionCollection(this._mock1.Object, this._mock2.Object);
        ...
        {
            var conditionCollection = new AndConditionCollection();
            Assert.AreEqual(true, conditionCollection.IsSatisfied);
        }
    }
}