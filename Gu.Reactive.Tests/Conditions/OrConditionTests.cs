namespace Gu.Reactive.Tests.Conditions
{
    ...
    public class OrConditionTests
    {
        ...
        public void IsSatisfiedIsTrueIfAnyChildIsTrue(bool? first, bool? second, bool? third, bool? expected)
        {
            ...
            var collection = new OrCondition(this._mock1.Object, this._mock2.Object, this._mock3.Object);
        ...
        public void NotifiesTest()
        {
            ...
            var collection = new OrCondition(this._mock1.Object, this._mock2.Object);
